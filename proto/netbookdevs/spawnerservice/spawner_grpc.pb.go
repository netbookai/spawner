...
type SpawnerServiceClient interface {
	...
	GetWorkspaceCost(ctx context.Context, in *GetWorkspaceCostRequest, opts ...grpc.CallOption) (*GetWorkspaceCostResponse, error)
...
func (c *spawnerServiceClient) GetWorkspaceCost(ctx context.Context, in *GetWorkspaceCostRequest, opts ...grpc.CallOption) (*GetWorkspaceCostResponse, error) {
	out := new(GetWorkspaceCostResponse)
	err := c.cc.Invoke(ctx, "/spawnerservice.SpawnerService/GetWorkspaceCost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SpawnerServiceServer interface {
	...
	GetWorkspaceCost(context.Context, *GetWorkspaceCostRequest) (*GetWorkspaceCostResponse, error)
...
func (UnimplementedSpawnerServiceServer) GetWorkspaceCost(context.Context, *GetWorkspaceCostRequest) (*GetWorkspaceCostResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetWorkspaceCost not implemented")
}
...
func _SpawnerService_GetWorkspaceCost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWorkspaceCostRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SpawnerServiceServer).GetWorkspaceCost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spawnerservice.SpawnerService/GetWorkspaceCost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SpawnerServiceServer).GetWorkspaceCost(ctx, req.(*GetWorkspaceCostRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SpawnerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetWorkspaceCost",
			Handler:    _SpawnerService_GetWorkspaceCost_Handler,
		},
		{
