...
var file_proto_netbookai_spawner_spawner_proto_rawDesc = []byte{
	...
	0x1e, 0x0a, 0x1c, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35, 0x33,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x1d, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35, 0x33, 0x54, 0x58, 0x54,
	0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x50,
	0x0a, 0x1c, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35, 0x33, 0x54, 0x58, 0x54, 0x52,
	...
	0x16, 0x2e, 0x73, 0x70, 0x61, 0x77, 0x6e, 0x65, 0x72, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35,
	0x33, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x52, 0x07, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73,
	0x22, 0x4f, 0x0a, 0x1b, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x35,
	...
	0x73, 0x22, 0x1e, 0x0a, 0x1c, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x6f, 0x75, 0x74, 0x65,
	0x35, 0x33, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x2a, 0x50, 0x0a, 0x0a, 0x4d, 0x49, 0x47, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x12,
	...
	0x01, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x50, 0x4f, 0x54, 0x10, 0x02, 0x32, 0xf0, 0x14, 0x0a, 0x0e,
	...
	0x6f, 0x72, 0x64, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0a,
	0x5a, 0x08, 0x2f, 0x73, 0x70, 0x61, 0x77, 0x6e, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_proto_netbookai_spawner_spawner_proto_depIdxs = []int32{
	...
	65, // 29: spawner.GetRoute53TXTRecordsResponse.records:type_name -> spawner.Route53Record
	65, // 30: spawner.DeleteRoute53RecordsRequest.records:type_name -> spawner.Route53Record
	56, // 31: spawner.GetCostByTimeResponse.GroupedCostEntry.value:type_name -> spawner.costMap
	2,  // 32: spawner.SpawnerService.HealthCheck:input_type -> spawner.Empty
	3,  // 33: spawner.SpawnerService.Echo:input_type -> spawner.EchoRequest
	8,  // 34: spawner.SpawnerService.CreateCluster:input_type -> spawner.ClusterRequest
	16, // 35: spawner.SpawnerService.AddToken:input_type -> spawner.AddTokenRequest
	18, // 36: spawner.SpawnerService.GetToken:input_type -> spawner.GetTokenRequest
	20, // 37: spawner.SpawnerService.AddRoute53Record:input_type -> spawner.AddRoute53RecordRequest
	9,  // 38: spawner.SpawnerService.GetCluster:input_type -> spawner.GetClusterRequest
	10, // 39: spawner.SpawnerService.GetClusters:input_type -> spawner.GetClustersRequest
	22, // 40: spawner.SpawnerService.AddNode:input_type -> spawner.NodeSpawnRequest
	14, // 41: spawner.SpawnerService.ClusterStatus:input_type -> spawner.ClusterStatusRequest
	24, // 42: spawner.SpawnerService.DeleteCluster:input_type -> spawner.ClusterDeleteRequest
	26, // 43: spawner.SpawnerService.DeleteNode:input_type -> spawner.NodeDeleteRequest
	28, // 44: spawner.SpawnerService.CreateVolume:input_type -> spawner.CreateVolumeRequest
	30, // 45: spawner.SpawnerService.DeleteVolume:input_type -> spawner.DeleteVolumeRequest
	32, // 46: spawner.SpawnerService.CreateSnapshot:input_type -> spawner.CreateSnapshotRequest
	61, // 47: spawner.SpawnerService.DeleteSnapshot:input_type -> spawner.DeleteSnapshotRequest
	34, // 48: spawner.SpawnerService.CreateSnapshotAndDelete:input_type -> spawner.CreateSnapshotAndDeleteRequest
	36, // 49: spawner.SpawnerService.RegisterWithRancher:input_type -> spawner.RancherRegistrationRequest
	38, // 50: spawner.SpawnerService.GetWorkspacesCost:input_type -> spawner.GetWorkspacesCostRequest
	39, // 51: spawner.SpawnerService.GetApplicationsCost:input_type -> spawner.GetApplicationsCostRequest
	46, // 52: spawner.SpawnerService.WriteCredential:input_type -> spawner.WriteCredentialRequest
	48, // 53: spawner.SpawnerService.ReadCredential:input_type -> spawner.ReadCredentialRequest
	50, // 54: spawner.SpawnerService.GetKubeConfig:input_type -> spawner.GetKubeConfigRequest
	53, // 55: spawner.SpawnerService.TagNodeInstance:input_type -> spawner.TagNodeInstanceRequest
	54, // 56: spawner.SpawnerService.GetCostByTime:input_type -> spawner.GetCostByTimeRequest
	57, // 57: spawner.SpawnerService.GetContainerRegistryAuth:input_type -> spawner.GetContainerRegistryAuthRequest
	60, // 58: spawner.SpawnerService.CreateContainerRegistryRepo:input_type -> spawner.CreateContainerRegistryRepoRequest
	63, // 59: spawner.SpawnerService.RegisterClusterOIDC:input_type -> spawner.RegisterClusterOIDCRequest
	66, // 60: spawner.SpawnerService.AppendRoute53Records:input_type -> spawner.AppendRoute53RecordsRequest
	68, // 61: spawner.SpawnerService.GetRoute53TXTRecords:input_type -> spawner.GetRoute53TXTRecordsRequest
	70, // 62: spawner.SpawnerService.DeleteRoute53Records:input_type -> spawner.DeleteRoute53RecordsRequest
	2,  // 63: spawner.SpawnerService.HealthCheck:output_type -> spawner.Empty
	4,  // 64: spawner.SpawnerService.Echo:output_type -> spawner.EchoResponse
	13, // 65: spawner.SpawnerService.CreateCluster:output_type -> spawner.ClusterResponse
	17, // 66: spawner.SpawnerService.AddToken:output_type -> spawner.AddTokenResponse
	19, // 67: spawner.SpawnerService.GetToken:output_type -> spawner.GetTokenResponse
	21, // 68: spawner.SpawnerService.AddRoute53Record:output_type -> spawner.AddRoute53RecordResponse
	11, // 69: spawner.SpawnerService.GetCluster:output_type -> spawner.ClusterSpec
	12, // 70: spawner.SpawnerService.GetClusters:output_type -> spawner.GetClustersResponse
	23, // 71: spawner.SpawnerService.AddNode:output_type -> spawner.NodeSpawnResponse
	15, // 72: spawner.SpawnerService.ClusterStatus:output_type -> spawner.ClusterStatusResponse
	25, // 73: spawner.SpawnerService.DeleteCluster:output_type -> spawner.ClusterDeleteResponse
	27, // 74: spawner.SpawnerService.DeleteNode:output_type -> spawner.NodeDeleteResponse
	29, // 75: spawner.SpawnerService.CreateVolume:output_type -> spawner.CreateVolumeResponse
	31, // 76: spawner.SpawnerService.DeleteVolume:output_type -> spawner.DeleteVolumeResponse
	33, // 77: spawner.SpawnerService.CreateSnapshot:output_type -> spawner.CreateSnapshotResponse
	62, // 78: spawner.SpawnerService.DeleteSnapshot:output_type -> spawner.DeleteSnapshotResponse
	35, // 79: spawner.SpawnerService.CreateSnapshotAndDelete:output_type -> spawner.CreateSnapshotAndDeleteResponse
	37, // 80: spawner.SpawnerService.RegisterWithRancher:output_type -> spawner.RancherRegistrationResponse
	41, // 81: spawner.SpawnerService.GetWorkspacesCost:output_type -> spawner.GetWorkspacesCostResponse
	42, // 82: spawner.SpawnerService.GetApplicationsCost:output_type -> spawner.GetApplicationsCostResponse
	47, // 83: spawner.SpawnerService.WriteCredential:output_type -> spawner.WriteCredentialResponse
	49, // 84: spawner.SpawnerService.ReadCredential:output_type -> spawner.ReadCredentialResponse
	51, // 85: spawner.SpawnerService.GetKubeConfig:output_type -> spawner.GetKubeConfigResponse
	52, // 86: spawner.SpawnerService.TagNodeInstance:output_type -> spawner.TagNodeInstanceResponse
	55, // 87: spawner.SpawnerService.GetCostByTime:output_type -> spawner.GetCostByTimeResponse
	58, // 88: spawner.SpawnerService.GetContainerRegistryAuth:output_type -> spawner.GetContainerRegistryAuthResponse
	59, // 89: spawner.SpawnerService.CreateContainerRegistryRepo:output_type -> spawner.CreateContainerRegistryRepoResponse
	64, // 90: spawner.SpawnerService.RegisterClusterOIDC:output_type -> spawner.RegisterClusterOIDCResponse
	67, // 91: spawner.SpawnerService.AppendRoute53Records:output_type -> spawner.AppendRoute53RecordsResponse
	69, // 92: spawner.SpawnerService.GetRoute53TXTRecords:output_type -> spawner.GetRoute53TXTRecordsResponse
	71, // 93: spawner.SpawnerService.DeleteRoute53Records:output_type -> spawner.DeleteRoute53RecordsResponse
